...
<main class="min-h-screen flex">
    <aside class="sidebar">
      <div class="mb-8">
        ...
        <p class="text-[9px] text-gray-300 text-center font-medium mb-2"><?php echo $userInfo->user_code ?></p>
      </div>

      <ul>
        <li>
          <a href="<?php echo SYSTEM_URL.'/customer-homepage' ?>" class="group aside-link <?php echo $tabActive == 'Homepage' ? 'active' : '' ?>">
        ...
        <li>
          <a href="<?php echo SYSTEM_URL.'/my-pets' ?>" class="group aside-link <?php echo $tabActive == 'Pets' ? 'active' : '' ?>">
        ...
        <li>
          <a href="<?php echo SYSTEM_URL.'/chats' ?>" class="group aside-link <?php echo $tabActive == 'Chats' ? 'active' : '' ?>">
      ...
      <div class="mt-auto">
        <a href="<?php echo SYSTEM_URL.'/settings' ?>" class="group aside-link <?php echo $tabActive == 'Settings' ? 'active' : '' ?>">
